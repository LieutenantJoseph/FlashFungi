// Flash Fungi - Quick Study Component
// Interactive flashcard-style study mode with progressive hints
...
window.QuickStudy = function QuickStudy(props) {
    ...
    const validateAnswer = (answer) => {
        ...
        const { finalScore, hintPenalty } = window.FuzzyMatching.applyHintPenalty(validation.baseScore, totalHintsUsed);
    ...
    return h('div', { style: { minHeight: '100vh', backgroundColor: '#f9fafb' } },
        ...
        showGuide && h(window.InteractiveSpeciesGuide, {
...
console.log('✅ QuickStudy component loaded');